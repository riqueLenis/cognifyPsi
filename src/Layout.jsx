        ...
        <div className="flex flex-col h-full">
          ...
          <div className="h-20 flex items-center justify-between px-6 border-b border-slate-100">
            <Link to={createPageUrl('Dashboard')} className="flex items-center gap-3">
              ...
              <div>
                <span className="font-semibold text-slate-800 text-lg tracking-tight">Cognify</span>
                ...
                <DropdownMenuTrigger asChild>
                  <button className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors">
                    ...
                    <div className="flex-1 text-left">
                      <p className="text-sm font-medium text-slate-700 truncate">{user.full_name || 'Psicólogo'}</p>
