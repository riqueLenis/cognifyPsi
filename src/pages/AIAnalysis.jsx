...
export default function AIAnalysis() {
  ...
  const { data: sessions = [] } = useQuery({
    ...
    queryFn: () =>
      base44.entities.Session.filter({ patient_id: selectedPatient }),
...
Seja preciso e profissional na análise. Identifique padrões emocionais, sinais de alerta e progressos terapêuticos.`;
    ...
    try {
      const invoke = base44?.integrations?.Core?.InvokeLLM;
      if (typeof invoke !== "function") {
        throw new Error(
          "InvokeLLM indisponível: base44.integrations.Core.InvokeLLM não existe.",
        );
      }
      ...
      const msg =
        err?.data?.error || err?.message || "Erro desconhecido ao analisar";
      setAnalysisError(msg);
      setAnalysis(null);
      console.error("AIAnalysis InvokeLLM error:", err);
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-500">
            Analise as notas das sessões e identifique padrões emocionais
          </p>
        </div>
      </div>
            ...
            <Card className="border-red-200 bg-red-50/50">
              ...
              <CardContent>
                <p className="text-sm text-red-700/80">
                  Dica: abra o Console do navegador para ver o erro completo.
                </p>
              </CardContent>
            </Card>
          )}
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3">
                        {analysis.overall_sentiment &&
                          sentimentConfig[analysis.overall_sentiment] && (
                            <>
                              <div
                                className={cn(
                                  "p-2 rounded-lg",
