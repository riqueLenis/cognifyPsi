...
export default function RecordForm({ record, patientId, patients = [], open, onClose, onSave }) {
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 mt-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => setFormData(prev => ({ ...prev, diagnosis_cid: e.target.value }))}
            ...
            <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl">
              <div>
                ...
                <p className="text-sm text-slate-500">Visível apenas para o psicólogo</p>
              </div>
              <Switch
          ...
          <div>
            ...
            <div className="mt-1.5">
              <ReactQuill
                ...
                onChange={(value) => setFormData(prev => ({ ...prev, treatment_plan: value }))}
                modules={quillModules}
          ...
          <div className="flex justify-end gap-3 pt-4 border-t">
            ...
            <Button 
              type="submit" 
              disabled={loading || !formData.patient_id || !formData.title || !formData.content}
